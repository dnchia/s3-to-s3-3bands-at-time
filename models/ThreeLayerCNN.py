...
class ThreeLayerCNN:
    ...
    def __init__(self, subimage_provider, input_tranform, target_transform,
                 batch_size=100, input_bands_count=21, target_bands_count=1,
                 first_layer_shape=(5, 5, 64), second_layer_shape=(5, 5, 32), third_layer_shape=(5, 5, 1),
    ...
    def _declare_loss_function(self, network, net_target, regularization_weights):
        with tf.name_scope('loss'):
            ...
            loss = tf.reduce_mean(tf.reduce_sum(error, [1, 2]))
